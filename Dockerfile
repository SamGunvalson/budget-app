...
# Fix CVE-2026-25646, CVE-2026-33636, CVE-2026-33416 (libpng); CVE-2026-22184, CVE-2026-27171 (zlib); CVE-2026-32767, CVE-2026-32776, CVE-2026-32777, CVE-2026-32778 (expat). Keep the Nginx package from the official image: Alpine's package replaces its config with an incompatible include layout.
RUN apk upgrade --no-cache libpng zlib expat
