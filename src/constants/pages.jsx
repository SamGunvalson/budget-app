/**
 * Central registry of all navigable pages.
 * Used by TopBar navigation, swipe navigation, and MobilePageDots.
 *
 * Pages that should appear in the main nav bar set `showInNav: true`.
 * The array order determines the swipe sequence on mobile.
 */
const PAGE_REGISTRY = [
  {
    id: 'transactions',
  ...
  },
  {
    ...
    showInNav: true,
    iconSmall: (
      <svg className="h-4 w-4 text-teal-600 dark:text-teal-400" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  },
  {
    ...
    showInNav: true,
    iconSmall: (
      <svg className="h-4 w-4 text-stone-600 dark:text-stone-400" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
